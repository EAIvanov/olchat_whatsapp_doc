...
{% hint style="danger" %}
Функционал открытых линий позволяет цитировать сразу несколько сообщений в одном ответе, однако WhatsApp процитирует лишь первое из них. Остальные цитаты будут отображаться некорректно. Настоятельно рекомендуем применять цитирование только к одному сообщению в ответе.
{% endhint %}
