...
Если вы используете в шаблонах переменные из полей сущности, нажмите на кнопку «ЗАПОЛНИТЬ ПЕРЕМЕННЫЕ», чтобы подставить значения полей в текст сообщения. Подробнее о работе с шаблонами в статье [Broken link](/broken/pages/-MGBG8SXp08ITHgRv8xB "mention")
