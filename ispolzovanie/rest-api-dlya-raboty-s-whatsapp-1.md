...
Создать вебхук можно в приложении **OLChat — «•••» (меню вызова настроек коннектора)** **— Настройки коннектора — Вебхук — Сгенерировать новый:**
...
Возвращает последние входящие сообщения из чата Открытой линии (включая WhatsApp, Telegram и другие подключённые каналы), привязанного к сущности CRM.
...
Возвращает последние исходящие сообщения из чата Открытой линии (включая WhatsApp, Telegram и другие подключённые каналы), привязанного к сущности CRM.
