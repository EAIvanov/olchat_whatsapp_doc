...
Чтобы управлять настройками групп, перейдите в приложение **Олчат — WhatsApp Группы.** Выберите нужную группу из списка подключенных групп. Выберите нужный контакт. Затем выберите действие, которое вы хотите произвести с данным контактом. Нажмите на кнопку «ВЫПОЛНИТЬ».
