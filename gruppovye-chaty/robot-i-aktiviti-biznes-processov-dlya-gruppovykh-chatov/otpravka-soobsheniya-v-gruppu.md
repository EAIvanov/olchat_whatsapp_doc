...
Используйте данное активити для отправки сообщений в любую из подключенных групп. Добавьте действие «\[Олчат] \[Группы] Отправка сообщения» и выполните его настройку.
...
Робот «\[Олчат] \[Группы] Отправка сообщения» позволяет создавать автоматизированные сценарии для отправки сообщений в подключенные группы при переходе лида или сделки в определённый статус.

Для добавления робота перейдите в **Роботы ‒ Создать ‒ Выбор стадии ‒ Другие роботы ‒ \[Олчат] \[Группы] Отправка сообщения ‒ Добавить.**
