...
В таблице Excel будут содержаться следующие данные: Название, Статус, ID группы. В ячейках, содержащих ID группы, будет указан как ID, так и номер линии, к которой относится подключённая группа.
