...
Рассмотрим ситуацию: вы получаете новое сообщение от клиента в открытую линию, после этого создаётся лид или сделка. Ответственный должен обработать данный лид или сделку по вашему внутреннему регламенту за определённый срок, например, в течение 30 минут, и, в случае, если он не сделал это, сотруднику можно отправить сообщение в WhatsApp с напоминанием, а к лиду или сделке прикрепить наблюдателя.
