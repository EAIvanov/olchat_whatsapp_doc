...
На стадию **«Новая регистрация»** добавим робота **«\[Олчат — Чаты и Группы WhatsApp] Отправка сообщения»,** в котором попросим клиента подтвердить регистрацию на мероприятие.
...
Далее, на текущую стадию добавим робота **«\[Олчат — Чаты и Группы WhatsApp] Ожидание сообщения».**
