...
Однако мы всё таки рекомендуем делать рассылку именно по базе CRM (cистемы управления взаимоотношениями с клиентами), так как в таком случае вы сможете использовать персонализацию, например, имя клиента, чтобы снизить риск блокировки.
