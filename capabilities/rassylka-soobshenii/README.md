...
Сохраните сегмент и создайте новую СМС-рассылку.
...
2. В качестве сервиса для отправки выберите «Олчат — Чаты и Группы WhatsApp» с нужным коннектором линии.
...
Вы можете увеличить интервалы между отправками сообщений в [настройках коннектора](/broken/pages/-MXVZVnBGVIblHBKthyO#intervaly-otpravki-soobshenii). Если вы используете номер в основном для рассылок, интервалы между отправкой помогут снизить риск блокировки. Также вы можете снизить риск блокировки с помощью [наших рекомендаций](https://docs.olchat.io/blokirovka-nomera).

### Почему нужно отправлять рассылку через СМС-функционал, а не через мессенджеры?
...
С помощью СМС-функционала рассылка отправляется по номеру телефона.
