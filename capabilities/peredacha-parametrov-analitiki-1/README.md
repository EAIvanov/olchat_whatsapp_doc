# Copy of Передача параметров аналитики
...
{% hint style="success" %}
Пошаговые инструкции по настройке виджета и сайта для передачи параметров аналитики содержатся в статьях [yandeks.metrika-clientid.md](../peredacha-parametrov-analitiki/yandeks.metrika-clientid.md "mention"), [roistat.md](../peredacha-parametrov-analitiki/roistat.md "mention") и [calltouch.md](../peredacha-parametrov-analitiki/calltouch.md "mention")
{% endhint %}
