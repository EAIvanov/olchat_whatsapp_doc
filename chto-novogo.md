...
Поистине космический, многогранный и интересный Релиз Олчат WhatsApp от июля 2025!\
\
Современный, ещё более удобный и понятный интерфейс, возвращение робота с кнопками, долгожданное исправление цитирования. Всё это и не только в обновлённой версии Олчат WhatsApp уже на ваших порталах!\
Если ещё не пользуетесь или перестали, самое время установить и испытать новые возможности Олчат WhatsApp!\
\
Итак, встречайте:\
\
...
\
3\. [Карточка ](https://docs.olchat.io/ispolzovanie/vidzhety-v-kartochke-crm/vidzhet-statusy-i-chaty#vybor-linii-i-nomera-telefona-klienta)не будет большой, если у вас в прикреплённых контактах и компаниях много номеров. В виджете «Олчат — статусы и чаты» будут видны только 5 номеров, остальные скрываются под кнопкой.\
\
4\. Иногда ваша линия может не работать, так как она отключена или удалена. Теперь эта [информация ](https://docs.olchat.io/ustanovka-i-nastroika/interfeisy-prilozheniya/opisanie-nastroek-konnektora#chto-oznachayut-preduprezhdayushie-simvoly-v-paneli-upravleniya-otkrytymi-liniyami)выводится в виде значков в основном приложении Олчат WhatsApp около линий.\
\
5\. Прокачали и [мобильное приложение](https://docs.olchat.io/ispolzovanie/poluchenie-i-otpravka-soobshenii/otpravka-soobshenii-iz-mobilnogo-prilozheniya-bitriks24), встроенное в Битрикс24. Теперь отправлять сообщения можно не только контактам, которые есть в вашей CRM (системе управления взаимоотношениями с клиентами), но и просто по номеру телефона. В таком случае создастся Лид (клиент) или Сделка в зависимости от ваших настроек линии.\
\
6\. Мы исправили цитирование! Теперь оно отображается корректно в виде цитаты.\
\
...
\
Подробнее обо всех новинках читайте в документации, а вопросы можно писать [сюда](https://t.me/olchat_support_bot).\
Ну, и лайк команде Олчат за неустанную работу. Рады трудиться, чтобы вы повышали качество коммуникации с вашими клиентами!
...
Мы уверены, что новые тарифы помогут вам выбрать оптимально решение для вашего бизнеса и максимально эффективно использовать Олчат WhatsApp.

🚀 **Узнайте больше о том, как использовать групповые чаты, по** [**ссылке**](https://docs.olchat.io/gruppovye-chaty/gruppy)**.**

## 17.05.2024

1. Работать с шаблонами сообщений стало еще удобнее! Теперь вы можете отправлять шаблоны напрямую из Открытых линий, что делает быстрые ответы в чатах доступными на всех тарифах Битрикс24 [Broken link](/broken/pages/-MGBG8SXp08ITHgRv8xB#otpravka-shablonnogo-soobsheniya-iz-chata-otkrytoi-linii "mention").
2. Появились новые настройки шаблонов. Вы можете задавать параметры в шаблонах, переменные из сущностей CRM (системы управления взаимоотношениями с клиентами) будут подставляться автоматически. Можно сортировать шаблоны по категориям и гибко настраивать права доступа для сотрудников [Broken link](/broken/pages/-MGBG8SXp08ITHgRv8xB "mention").
...
1. Современный, удобный, интуитивно понятный — новый интерфейс приложения Олчат WhatsApp [opisanie-paneli-prilozheniya.md](ustanovka-i-nastroika/interfeisy-prilozheniya/opisanie-paneli-prilozheniya.md "mention").
2. Обновлённый интерфейс настроек коннектора для быстрого подключения, легкого и понятного процесса настроек [Broken link](/broken/pages/-MXVZVnBGVIblHBKthyO "mention").
...
2. Добавили REST API (программный интерфейс) для WhatsApp, позволяющий интегрировать наш сервис с другими интерфейсами и сервисами. Теперь вы можете отправлять сообщения и файлы в WhatsApp, проверять наличие на номере, проверять статусы линии и сообщений там, где вам удобно [Broken link](/broken/pages/4bthxdy3lyyqzgrtWgoM "mention").
...
4. В настройках коннектора добавили возможность устанавливать интервалы между отправкой сообщений в WhatsApp [Broken link](/broken/pages/-MXVZVnBGVIblHBKthyO#5-nastroiki-chata "mention").
...
1. Внесли изменения на страницу настроек коннектора. Теперь наверху удобно отслеживать статус подключения и номер телефона, вниз перенесли до какого числа линия оплачена [Broken link](/broken/pages/-MXVZVnBGVIblHBKthyO#2-3-bloki-so-statusami-podklyucheniya "mention") .
...
1. В виджете Олчат теперь отображается информация о том, в каком регионе зарегистрирован номер клиента, информация об операторе и времени клиента [vidzhet-statusy-i-chaty.md](ispolzovanie/vidzhety-v-kartochke-crm/vidzhet-statusy-i-chaty.md "mention").
...
3. Можно записывать и отправлять голосовые сообщения клиентам в WhatsApp прямо из вашего Битрикс24 с помощью приложения Олчат [#otpravka-soobshenii](ispolzovanie/poluchenie-i-otpravka-soobshenii/kak-napisat-pervym-cherez-prilozhenie-olchat-v-kartochke.md#otpravka-soobshenii "mention").
...
10. Положили конец проблеме c прослушиванием голосовых сообщений на устройствах Apple. Теперь голосовые можно открывать и прослушивать через альтернативную ссылку/
...
3. Добавили поддержку Смарт-процессов и возможность использовать виджет «Олчат WhatsApp — статусы и чаты» в карточке Смарт-процесса. Подробнее в статье [#kak-pokazat-vidzhet-statusy-i-chaty-v-kartochke-smart-processa](ispolzovanie/vidzhety-v-kartochke-crm/#kak-pokazat-vidzhet-statusy-i-chaty-v-kartochke-smart-processa "mention").
4.  Отправили бота-помощника на курсы повышения квалификации. Теперь он может:

    * Добавлять в название чата текущую стадию, привязанную к диалогу.
    * Добавлять параметры из полей сущностей CRM (cистема управления взаимоотношениями с клиентами)/
...
3. Все телефоны в одном виджете. Если у вас к сущности CRM (cистемы управления взаимоотношениями с клиентами) прикреплено несколько контактов или компаний, в виджет Олчат подтянутся телефоны из всех карточек (до 10 телефонов).
...
* Устанавливает и обновляет изображение контакта клиента.
* Запись идентификатора аналитики Roistat, ClientID, UserID и так далее в поле системы управления взаимоотношениями с клиентами.
* Возможность установки бота, которому передается управление после бота Олчат.

### Роботы

#### Новые роботы

* Робот отправки файлов теперь поддерживает отправку файлов по прямой ссылке, из диска, из поля системы управления взаимоотношениями с клиентами. [Подробнее](roboty-i-aktiviti/roboty/otpravka-faila.md).
* Робот отправки местоположения. [Подробнее](roboty-i-aktiviti/roboty/otpravka-geometki.md).
...
### [Роботы групп](https://docs.olchat.io/gruppovye-chaty/robot-i-aktiviti-biznes-processov-dlya-gruppovykh-chatov)

### [Рассылки](gruppovye-chaty/robot-i-aktiviti-biznes-processov-dlya-gruppovykh-chatov/)
