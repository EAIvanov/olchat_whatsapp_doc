...
\
8\. Ну, и для самых прокаченных, сделали возможность добавлять [подпись к файлу](https://docs.olchat.io/ispolzovanie/rest-api-dlya-raboty-s-whatsapp#kak-dobavit-podpis-k-failu-otpravlennomu-cherez-rest-api) при отправке через REST API.\
\
...
2. Добавили REST API для WhatsApp, позволяющий интегрировать наш сервис с другими интерфейсами и сервисами. Теперь вы можете отправлять сообщения и файлы в WhatsApp, проверять WA на номере, проверять статусы линии и сообщений там, где вам удобно [Broken link](/broken/pages/4bthxdy3lyyqzgrtWgoM "mention")
