...
По истине космический, многогранный и интересный Релиз OLChat WhatsApp от июля 2025!\
\
Современный, ещё более удобный и понятный интерфейс, возвращение робота с кнопками, долгожданное исправление цитирования. Всё это и не только в обновлённой версии OLChat WhatsApp уже на ваших порталах!\
Если ещё не пользуетесь или перестали, самое время установить и испытать новые возможности OLChat WhatsApp!\
\
Итак, встречайте:\
\
1\. Интерфейс основных настроек приложения и групп сделали более современным и адаптивным, а еще расширили возможности настроек для больших сценариев работы.\
\
2\. Сделали сортировку шаблонов более удобной: в настройках добавления шаблонов они идут по алфавиту, а в Открытых линиях, при использовании шаблонов, вы видите 5 последних использованных шаблонов. Остальные никуда не пропали, а находятся ниже. Теперь по умолчанию выбрана последняя использованная категория шаблонов для вашего удобства.\
\
...
\
4\. Иногда ваша линия может не работать, так как она отключена или удалена. Теперь эта информация выводится в виде значков в основном приложении OLChat WhatsApp около линий.\
\
5\. Прокачали и мобильное приложение, встроенное в Битрикс24. Теперь отправлять сообщения можно не только контактам, которые есть в вашей CRM, но и просто по номеру телефона. В таком случае создастся Лид или Сделка в зависимости от ваших настроек линии.\
\
6\. Мы исправили цитирование! Теперь оно отображается корректно в виде цитаты.\
\
7\. Возвращение, которого многие ждали: Робот с кнопками. Всё верно, снова можно отправлять такие сообщения через обычный WhatsApp, а это значит, что реализовывать кучу классных сценариев для работы с клиентами стало проще!\
\
8\. Ну, и для самых прокаченных, сделали возможность добавлять подпись к файлу при отправке через REST API.\
\
Как вам такой релиз OLChat WhatsApp?)\
С нетерпеньем ждём вашей обратной связи в комментариях!\
\
Подробнее обо всех новинках читайте в документации, а вопросы можно писать [сюда](https://t.me/olchat_support_bot).\
Ну, и лайк команде OLChat за неустанную работу. Рады трудиться, чтобы вы повышали качество коммуникации с вашими клиентами!1
