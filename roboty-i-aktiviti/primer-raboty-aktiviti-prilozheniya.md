...
{% file src="../.gitbook/assets/OLChat.rar" %}
...
1. Дано 2 номера телефона в карточке контакта. С помощью активити **«\[Олчат] WhatsApp - Проверка WhatsApp на номере»** проверяем, на каком из номеров есть WhatsApp и выводим результат проверки в уведомление.
2. Номер, на котором есть WhatsApp добавляем в пользовательское поле «Номер с WA».
3. Выполняем отправку сообщения на номер, указанный в поле «Номер с WA» с помощью активити **«\[Олчат] WhatsApp - Отправка сообщения».**
4. Выполняем отправку контакта из поля «Контакт (номер) WA» на номер, указанный в поле «Номер с WA» с помощью активити **«\[Олчат] WhatsApp - Отправка контакта».**
5. Выполняем отправку файла (картинки) на номер, указанный в поле «Номер с WA» с помощью активити **«\[Олчат] WhatsApp - Отправка файла».**
6. Выполняем отправку сообщения в одну из подключенных групп с помощью активити **«\[Олчат] WhatsApp - Отправка сообщения в группу».**
...
\&#xNAN;**— \[Олчат] WhatsApp - Отправка сообщения.**\
&#xNAN;**— \[Олчат] WhatsApp - Отправка контакта.**\
&#xNAN;**— \[Олчат] WhatsApp - Отправка файла.**

![](<../.gitbook/assets/image (917).png>)

![](<../.gitbook/assets/image (738).png>)

7\. Укажите группу, в которую необходимо отправить сообщение в активити **«\[Олчат] WhatsApp - Отправка сообщения в группу».**
