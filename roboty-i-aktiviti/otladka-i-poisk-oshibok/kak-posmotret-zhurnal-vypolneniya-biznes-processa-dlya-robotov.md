...
{% hint style="warning" %}
По умолчанию журнал выполнения бизнес-процессов отключён. Подробнее о том, как включить журнал отладки бизнес-процессов (хранение логов), написано в [данной статье](https://helpdesk.bitrix24.ru/open/21994508/) Битрикс24.&#x20;
{% endhint %}

При разработке и использовании уже настроенных роботов и бизнес-процессов, бывает так, что необходимо узнать подробности выполнения того или иного робота или действия. Для этого в системе предусмотрен журнал выполнения бизнес-процессов (лог).
