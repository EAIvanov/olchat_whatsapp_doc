...
Для установки роботов и активити нажмите на кнопку **«**<img src="../../.gitbook/assets/image.png" alt="" data-size="line"> **ОБНОВИТЬ РОБОТОВ»**. После нажатия на кнопку, появится уведомление об успешной установке роботов, а статус возле названия робота поменяет значение с <img src="../../.gitbook/assets/image (1401).png" alt="" data-size="line"> на <img src="../../.gitbook/assets/image (1).png" alt="" data-size="line">.
