...
Робот «\[Олчат] \[ОЛ] Изменить заголовок чата» позволяет произвольным образом изменить заголовок чата. Для этого необходимо знать ID чата.
...
Для добавления робота перейдите в **Роботы ‒ Создать ‒ Выбор стадии ‒ Другие роботы ‒ \[Олчат] \[ОЛ] Изменить заголовок чата ‒ Добавить.**
