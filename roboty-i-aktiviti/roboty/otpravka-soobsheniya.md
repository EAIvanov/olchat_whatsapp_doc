...
Для отправки сообщения добавьте робота «\[Олчат — Чаты и Группы WhatsApp] WhatsApp Отправка сообщения». Для этого перейдите в **Роботы ‒ Создать ‒ Выбор стадии ‒ Другие роботы ‒ \[Олчат] Отправить сообщение ‒ Добавить.**
...
{% hint style="info" %}
_**Важно:**_ убедитесь, что в роботе выбрано корректное поле с номером телефона. Если в карточке клиента заполнено поле «Мобильный телефон», а в настройке робота указано \{{Рабочий телефон\}}, робот не найдёт номер и сообщение не будет отправлено.\
Чтобы робот корректно подставлял номер из всех заполненных телефонных полей, рекомендуем в строке «Номер телефона» выбрать переменную \{{Телефон (текст)\}}. Указать её можно через меню «…» (три точки) напротив строки «Номер телефона».
{% endhint %}

3. Введите текст **Сообщения.**
4. Выберите **Очередь отправки.** Настройка позволяет установить паузы между отправляемыми сообщениями. Паузы устанавливаются в настройках коннектора. Подробнее в статье [Broken link](/broken/pages/-MXVZVnBGVIblHBKthyO#intervaly-otpravki-soobshenii "mention"). Доступны варианты:
...
Результат работы робота «\[Олчат — Чаты и Группы WhatsApp] WhatsApp - Отправка сообщени&#x44F;**»** можно вывести в уведомления или использовать в условиях для выстраивания различных сценариев автоматизации.
...
Результат работы активити **«\[Олчат] WhatsApp - Отправка сообщения»** можно вывести в уведомления или использовать в условиях для выстраивания различных сценариев автоматизации.
