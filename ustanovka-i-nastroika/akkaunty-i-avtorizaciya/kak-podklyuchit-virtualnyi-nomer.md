...
* номера VoIP (виртуального номера, осуществляющего вызовы через интернет);
* номера бесплатного доступа;
* номера с платными входящими;
* универсального номера доступа (UAN).

{% hint style="info" %}
У WhatsApp есть функция подтверждения номера по звонку в случае, если нет возможности подтвердить регистрацию с помощью смс-сообщения. Чаще всего к такому методу прибегают при регистрации стационарного (городского) телефонного номера.
{% endhint %}

### Можно ли у вас арендовать номер?

Компания Олчат не оказывает услуги, связанные с арендой номеров. Вы можете обратиться к операторам связи для решения данного вопроса.
