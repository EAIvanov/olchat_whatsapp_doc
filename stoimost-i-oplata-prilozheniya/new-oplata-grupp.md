...
В случае, если планируете оплатить только один тариф групп, можно выбрать необходимый тариф из Списка аккаунтов на главной станице приложения, нажать на "<img src="../.gitbook/assets/image (1) (1) (1).png" alt="" data-size="line">" в конце строки, затем выбрать "Оплатить".
