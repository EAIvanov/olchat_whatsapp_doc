...
Перенос оплаты с одного приложения на другое, например, с OLChat WhatsApp на OLChat Telegram, обсуждается в индивидуальном порядке. Напишите нам в [чат поддержки](https://auth2.bitrix24.net/oauth/select/?preset=im\&IM_DIALOG=networkLines7c380c91ab28dacab02d3af93fecdbf9), чтобы узнать дополнительную информацию.
{% endhint %}
