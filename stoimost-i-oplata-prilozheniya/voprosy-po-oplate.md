...
#### Что делать, если номер счёта не указан или произведена оплата без выставления счёта?&#x20;

Если вы оплатили повторно старый счет или в платежном поручении в назначении платежа не указали номер счёта, или оплатили без выставления счета, вам необходимо:

1. Выставить новый счёт.
...
{% file src="../.gitbook/assets/Письмо об уточнении назначения платежа (1) (1).docx" %}

#### Что делать, если счёт оплачен от лица другой компании?

Если вы оплатили счёт от лица другой компании, необходимо отправить отсканированный файл письма на официальном бланке организации на **support@olchat.io**, либо в [чат Битрикс24](https://auth2.bitrix24.net/oauth/select/?preset=im\&IM_DIALOG=networkLines7c380c91ab28dacab02d3af93fecdbf9), в котором необходимо указать:
...
{% file src="../.gitbook/assets/Письмо об уточнении назначения платежа (2) (1).docx" %}

{% hint style="info" %}
Обращаем внимание, что на официальном бланке организации обязательно должна быть подпись ответственного лица, а также проставлена печать организации.
{% endhint %}
