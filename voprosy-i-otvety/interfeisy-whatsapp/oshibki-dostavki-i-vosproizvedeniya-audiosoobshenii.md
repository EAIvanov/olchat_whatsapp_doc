...
Используйте полученный преобразованный файл для отправки с помощью робота или в активии бизнес-процесса **\[Олчат — Чаты и Группы WhatsApp] WhatsApp - Отправка голосового сообщения.**
