# Ошибка загрузки страницы Олчат на портале Битрикс24

На некоторых устройствах пользователи могут сталкиваться с ошибкой загрузки страницы Олчат при попытке перейти на неё на портале Битрикс24. В этом случае вы можете видеть такое уведомление: «Веб-страница по адресу ... возможно, временно недоступна или постоянно перемещена по новому адресу».
