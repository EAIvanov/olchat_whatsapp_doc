...
Если нет контакта клиента в CRM (в системе управления взаимоотношениями с клиентами), то распределяется на того, кто указан в разделе Очереди в настройках Открытой линии.
